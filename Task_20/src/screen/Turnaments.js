import { Text, View,StyleSheet,Image,ScrollView,FlatList,Alert,TouchableOpacity,Share,Modal,Button } from 'react-native'
...
export default class Turnaments extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Modal            
          ...
          <View style = {styles.ModelContainer}>  
              ...
              <Text style={styles.DescriptionPopUpText}>Create new tournament or follow a{'\n'}public tournament.</Text>
              <FlatList
              data={this.state.PopUpData}
              renderItem={({item})=>
              <TouchableOpacity style={styles.FlatlistPopUpView} onPress={()=>this.props.navigation.navigate('CreateNewTurnaments')}>
                <Image source={item.TrophyImage}></Image>
                <Text style={styles.PopUpTextStyle}>{item.PopUpText}</Text>
                <Image source={item.RightArrowImage} style={styles.RightArrowImageStyle}></Image>
              </TouchableOpacity>
              }></FlatList> 
               <TouchableOpacity onPress = {() => {this.setState({ isVisible: false})}} style={styles.CanclePopUp}>
                 <Image source={require('../assets/images/CloseButton.png')} ></Image>
          </TouchableOpacity>
    ...
    <TouchableOpacity style={{alignSelf:'center',marginTop:-30,marginBottom:20}} onPress = {() => {this.setState({ isVisible: true})}} >
